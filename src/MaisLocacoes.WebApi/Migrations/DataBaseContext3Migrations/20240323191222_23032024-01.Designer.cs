...
{
    [DbContext(typeof(DataBaseContext3))]
    [Migration("20240323191222_23032024-01")]
    partial class _2303202401
    {
            ...
            modelBuilder.Entity("Repository.v1.Entity.QgEntity", b =>
                {
                    ...
                    b.HasOne("Repository.v1.Entity.RentedPlaceEntity", "RentedPlace")
                        .WithMany("Qgs")
                        .HasForeignKey("RentedPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Qgs_RentedPlaces");

                    b.Navigation("Address");

                    b.Navigation("RentedPlace");
                });
            ...
            modelBuilder.Entity("Repository.v1.Entity.RentedPlaceEntity", b =>
                {
                    ...
                    b.HasOne("Repository.v1.Entity.ProductTuitionEntity", "ProductTuition")
                        .WithMany("RentedPlaces")
                        .HasForeignKey("ProductTuitionId")
                        .HasConstraintName("FK_RentedPlaces_ProductTuitions");
