...
{
    public partial class _201020231 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateBought = table.Column<DateTime>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    SignedAt = table.Column<DateTime>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    InitialDateTime = table.Column<DateTime>(type: "timestamp", nullable: false),
                    FinalDateTime = table.Column<DateTime>(type: "timestamp", nullable: false),
                    Parts = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    Status = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false, defaultValue: "scheduled"),
                    FirstDueDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    QuantityPeriod = table.Column<int>(type: "integer", nullable: false),
                    TimePeriod = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PayDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    DueDate = table.Column<DateTime>(type: "timestamp", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    InvoiceEmittedDate = table.Column<DateTime>(type: "timestamp", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialDateTime = table.Column<DateTime>(type: "timestamp", nullable: true),
                    FinalDateTime = table.Column<DateTime>(type: "timestamp", nullable: true),
