...
{
    public class UpdateQgValidator : AbstractValidator<UpdateQgRequest>
    {
        public UpdateQgValidator()
        {
            ...
            RuleFor(qg => qg.Longitude)
                ...
                .WithMessage("Valor de Longitude deve ser válido ");

            RuleFor(qg => qg.Address).SetValidator(new UpdateAddressValidator());
        }
    }
}