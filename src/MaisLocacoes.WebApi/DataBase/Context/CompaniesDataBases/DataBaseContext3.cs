...
{
    public class DataBaseContext3 : DataBaseCompanyBaseContext
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IConfiguration _configuration;

        public DataBaseContext3() { }

        public DataBaseContext3(DbContextOptions<DbContext> options)
                : base(options)
        { }

        public DataBaseContext3(DbContextOptions<DbContext> options, IHttpContextAccessor httpContextAccessor, IConfiguration configuration)
                : base(options)
        {
